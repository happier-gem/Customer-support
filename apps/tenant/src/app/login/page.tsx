...
export default function LoginPage() {
  ...
  // Set only when the backend rejects login specifically because the
  // account's email isn't verified yet — distinct from a generic error so
  // we can offer a real recovery action instead of a dead-end message.
