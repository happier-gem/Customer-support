...
// starts throwing a raw "Unauthorized" on the next request (e.g. sending a
// team invite) with no recovery except a full page reload. Refreshing well
// before expiry (10m, a 5-minute safety margin) keeps the token perpetually
// valid for as long as the refresh cookie itself lasts.
